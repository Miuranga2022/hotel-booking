...
function FeaturedDestination() {
  ...
  return rooms.length > 0 && (
      <div className="flex flex-col  items-center justify-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20">
          <Title title='Featured Destination' subtitle='Discover Our handpicked selection of exceptional properties arround the world, offering unparalleled luxury and unforgettable experiences.'/>
